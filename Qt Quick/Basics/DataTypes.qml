...
Window{
    ...
    property var aFunction: function() { return "six"; } // we can assing the function expression
    property var aFont: Qt.font({family:"Comics Sans MS", pointSize: 12, bold: !customBool})
    property date customDate: "2021-10-14"
    ...
    Component.onCompleted: { // after the window gets loaded or executed
        ...
        console.log(`Day: ${customDate.getDay()}, Month: ${customDate.getMonth()}`) // see docs for more
